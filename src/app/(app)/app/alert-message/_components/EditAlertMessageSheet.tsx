...
const EditAlertMessageSheet = ({ children, data }: Props) => {
              ...
              return (
                <Form className="w-full h-full  flex flex-col px-1">
                  <div className="flex-1 gap-4 space-y-5 pb-8">
                    ...
                    <div className="w-full space-y-1">
                      <Text size="sm" weight="semibold" color="primary">Type</Text>
                      <Combobox
                        ...
                        <div className="space-y-5 pb-2">
                          ...
                          {values.buttons.map(
                            (
                              button: {
                                title?: string | number;
                                web_link?: string | number;
                                ios_link?: string | number;
                                android_link?: string | number;
...
export default EditAlertMessageSheet;
