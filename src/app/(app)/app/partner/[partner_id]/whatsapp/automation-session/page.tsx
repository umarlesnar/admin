...
import AutomationSessionPageHeader from "./_components/AutomationSessionPageHeader";
import { AutomationSessionList } from "./_components/AutomationSessionList";

export const metadata: Metadata = {
  title: "Automation Session",
};

export default function PartnerAutomationSessionPage() {
  return (
    <>
      <section
