...
import WhatsappPageHeader from "./_components/WhatsappPageHeader";
import { WhatsappAccountList } from "./_components/WhatsappList";
...
export default function PartnerWhatsappPage() {
  return (
    <>
      {/* Primary column */}
      <section
