...
import { AutomationLogsList } from "./_components/AutomationLogsList";
import AutomationLogsPageHeader from "./_components/AutomationLogsPageHeader";
...
export default function InstagramAutomationLogPage() {
  return (
    <>
      {/* Primary column */}
      <section
