...
import { InstagramAccountList } from "./_components/InstagramList";
import InstagramPageHeader from "./_components/InstagramPageHeader";
...
export default function PartnerInstagramPage() {
  return (
    <>
      {/* Primary column */}
      <section
