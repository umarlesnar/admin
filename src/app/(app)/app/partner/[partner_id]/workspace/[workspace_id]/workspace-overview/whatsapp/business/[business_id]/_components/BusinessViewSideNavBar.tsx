...
const BusinessViewSideNavBar = (props: Props) => {
  ...
  const sidebarNavigation = [
    {
      name: "Overview",
      href: `/app/partner/${partnerId}/workspace/${params?.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/overview`,
      icon: OverviewIcon2,
    },
  ];
  ...
  const whatsappNavigation = [
    {
      name: "Account",
      href: `/app/partner/${partnerId}/workspace/${params?.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/whatsapp-account`,
      icon: RoundIcon,
    },
    {
      name: "Whatsapp Info",
      href: `/app/partner/${partnerId}/workspace/${params?.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/whatsapp-info`,
      icon: RoundIcon,
    },
    {
      name: "Webhook Subscription",
      href: `/app/partner/${partnerId}/workspace/${params?.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/webhook-subscription`,
      icon: RoundIcon,
    },
  ];
  const bottomNavigation = [
    {
      name: "Agents",
      href: `/app/partner/${partnerId}/workspace/${params.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/agents`,
      icon: AgentsIcon,
    },

    {
      name: "Template",
      href: `/app/partner/${partnerId}/workspace/${params.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/template`,
      icon: TemplateIcon2,
    },
    {
      name: "Payments",
      href: `/app/partner/${partnerId}/workspace/${params.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/payments`,
      icon: Currency2Icon,
    },
    {
      name: "Settings",
      href: `/app/partner/${partnerId}/workspace/${params.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/settings`,
      icon: Setting2Icon,
    },
  ];
  const intergrationNavigation = [
    {
      ...
      href: `/app/partner/${partnerId}/workspace/${params.workspace_id}/workspace-overview/whatsapp/business/${selectedBusinessId}/integration`,
