...
const BusinessViewSideNavBar = (props: Props) => {
  ...
  const sidebarNavigation = [
    {
      name: "Overview",
      href: `/app/workspace/${params?.workspace_id}/business/${selectedBusinessId}/overview`,
      icon: OverviewIcon2,
    },
  ];
  ...
  const whatsappNavigation = [
    {
      name: "Account",
      href: `/app/workspace/${params?.workspace_id}/business/${selectedBusinessId}/whatsapp-account`,
      icon: RoundIcon,
    },
    {
      name: "Whatsapp Info",
      href: `/app/workspace/${params?.workspace_id}/business/${selectedBusinessId}/whatsapp-info`,
      icon: RoundIcon,
    },
    {
      name: "Webhook Subscription",
      href: `/app/workspace/${params?.workspace_id}/business/${selectedBusinessId}/webhook-subscription`,
      icon: RoundIcon,
    },
  ];
  const bottomNavigation = [
    {
      name: "Agents",
      href: `/app/workspace/${params.workspace_id}/business/${selectedBusinessId}/agents`,
      icon: AgentsIcon,
    },

    {
      name: "Template",
      href: `/app/workspace/${params.workspace_id}/business/${selectedBusinessId}/template`,
      icon: TemplateIcon2,
    },
    {
      name: "Payments",
      href: `/app/workspace/${params.workspace_id}/business/${selectedBusinessId}/payments`,
      icon: Currency2Icon,
    },
    {
      name: "Settings",
      href: `/app/workspace/${params.workspace_id}/business/${selectedBusinessId}/settings`,
      icon: Setting2Icon,
    },
  ];
  const intergrationNavigation = [
    {
      ...
      href: `/app/workspace/${params.workspace_id}/business/${selectedBusinessId}/integration`,
