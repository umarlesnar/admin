...
import WorkspaceViewHeader from "../_components/WorkspaceViewHeader";
import SettingsSideNavBar from "../../settings/_components/SettingsSideNavBar";
import { OnboardWorkspaceLists } from "./_components/OnboardWorkspaceList";
    ...
    <div className="flex flex-wrap mb-3">
      <div className="mr-auto pr-3 align-middle">
        <div className="text-nowrap inline-block">
          <Text tag={"h1"} size={"xl"} weight="medium">
...
export default function OnboardWorskspacePage() {
  return (
    <>
      {/* Primary column */}
      <section
