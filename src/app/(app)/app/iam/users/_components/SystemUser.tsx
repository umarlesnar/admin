...
import { useSystemUserQuery } from "@/framework/iam/system/get-user";
...
export const SystemUserLists = (props: Props) => {
  ...
  const { data, isLoading, refetch } = useSystemUserQuery(queryPage);
      ...
      <div className="flex items-center space-x-3">
        <div className="mt-6">
          <SearchBox
            ...
            placeholder="Search system user name"
            onChange={(e) => {
        ...
        queryPage.page == 1 ? (
          <>
            <div className="w-full h-full flex items-center justify-center flex-col space-y-3 bg-white">
              ...
              <Text size="2xl" weight="semibold">{`No System User Found`}</Text>
            </div>
          </>
        ) : (
          <AsyncTable
