...
import { useLegacyApiKeysQuery } from "@/framework/iam/api-key-management/get-legacy-api-keys";
...
export const LegacyLists = (props: Props) => {
  ...
  const { data, isLoading, refetch } = useLegacyApiKeysQuery(queryPage);
