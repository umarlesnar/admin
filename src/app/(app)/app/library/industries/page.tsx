...
import LibraryPageHeader from "../_components/LibraryPageHeader";
import LibrarySideNavBar from "../_components/LibrarySidenavbar";
import IndustriesSideNavBar from "./_components/IndustriesSidenavbar";
import IndustriesFormPage from "./_components/IndustriesFormPage";

export const metadata: Metadata = {
  title: "Library | Industries",
};
          ...
          <div className="w-full h-full flex flex-col max-w-full self-center space-y-3 py-3  sm:px-3.5 md:px-4 lg:px-5 @container min-h-full">
            <div className="w-full h-full flex-1 flex flex-col max-w-full self-center">
              ...
              <div className="flex flex-1 gap-2 w-full h-full mt-5 mr-auto overflow-auto bg-scroll">
                <LibrarySideNavBar />
                <IndustriesSideNavBar />
                <div className="w-[70%] flex bg-white h-full rounded-md p-4">
                <IndustriesFormPage />
                </div>
              </div>
            </div>
