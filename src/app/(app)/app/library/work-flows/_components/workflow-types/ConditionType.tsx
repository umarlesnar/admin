...
import WorkflowConditionSheet from "../workflow-sheet/WorkflowConditionSheet";

const WorkflowConditionType = ({ data, id }: any) => {
    ...
    <div className="w-60  bg-white rounded-md p-1 group relative">
      ...
      <div className="w-full h-10 bg-violet-100 rounded flex items-center justify-between gap-3 p-2">
        ...
        <div className="group-hover:flex items-center gap-2 hidden">
          ...
          <WorkflowConditionSheet data={data} id={id}>
            <EditIcon className="w-3 h-3 cursor-pointer" />
          </WorkflowConditionSheet>
          <DeleteIcon
              ...
              onConnect={(params: any) => {
                if (updateNodeData) {
                  updateNodeData(id, {
                    ...
                    condition_result: {
                      ...data.condition_result,
                      n_result_node_id: params.target,
                    },
                  });
                }
              }}
...
export default WorkflowConditionType;
