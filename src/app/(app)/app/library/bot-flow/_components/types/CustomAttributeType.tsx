...
import CustomAttributeTypeSheet from "../flow-sheets/CustomAttributeTypeSheet";

const CustomAttributeType = ({ data, id }: any) => {
    ...
    <div className="w-60  bg-white rounded-md p-1 group relative">
      ...
      <div className="w-full h-full bg-primary-50 rounded flex items-start justify-between gap-3 p-2">
        <div className="flex items-start gap-2 ">
          <AttributeIcon className="w-[18px] h-[18px] text-green-500" />
          <div>
...
export default CustomAttributeType;
