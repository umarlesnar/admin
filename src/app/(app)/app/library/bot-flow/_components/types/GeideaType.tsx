...
import GeideaTypeSheet from "../flow-sheets/GeideaTypeSheet";
import { GeideaBrandIcon } from "@/components/ui/icons/GeideaIcon";

const GeideaType = ({ data, id }: any) => {
    ...
    <div className="w-60  bg-white rounded-md p-1 group relative">
      ...
      <div className="w-full h-full bg-primary-50 rounded flex items-start justify-between gap-3 p-2">
        <div className="flex items-start gap-2 ">
          <GeideaBrandIcon className="w-[18px] h-[18px]" />
          <div>
        ...
        <div className="group-hover:flex items-center gap-2 hidden mt-1">
          ...
          <GeideaTypeSheet data={data} id={id}>
