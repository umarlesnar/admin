...
import OrderAddressTypeSheet from "../flow-sheets/OrderAddressTypeSheet";
import { LocationIcon } from "@/components/ui/icons/LocationIcon";
import { FlowStartIcon } from "@/components/ui/icons/FlowStartIcon";

const OrderAddressType = ({ data, id }: any) => {
    ...
    <div className="w-72 h-14 bg-white rounded-md p-1 group relative">
      ...
      <div className="w-full h-full bg-primary-50 rounded flex items-center justify-between gap-3 p-3">
        <div className="flex items-center gap-2">
          <LocationIcon className="w-[18px] h-[18px] text-green-500" />
          <div>
        ...
        <div className="group-hover:flex items-center gap-2 hidden">
          ...
          <OrderAddressTypeSheet data={data} id={id}>
            <EditIcon className="w-3 h-3 cursor-pointer" />
          </OrderAddressTypeSheet>
