...
import OpenAiSheet from "../flow-sheets/OpenAiSheet";

const OpenAiType = ({ data, id }: any) => {
  const { nodes, deleteNode, setStartNode, updateNodeData } = useStore();
    ...
    <div className="w-60  bg-white rounded-md p-1 group relative">
      ...
      <div className="w-full h-full bg-primary-50 rounded flex items-start justify-between gap-3 p-2">
        <div className="flex items-center gap-2 ">
          <OpenAiIcon className="w-[18px] h-[18px] text-green-500" />
