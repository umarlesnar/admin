...
import TriggerChatbotTypeSheet from "../flow-sheets/TriggerChatbotTypeSheet";

const TriggerChatbotType = ({ data, id }: any) => {
    ...
    <div className="w-60  bg-white rounded-md p-1 group relative">
      ...
      <div className="w-full h-full bg-primary-50 rounded flex items-start justify-between gap-3 p-2">
        <div className="flex items-start gap-2 ">
          <BotIcon className="w-[18px] h-[18px] text-green-500" />
          <div>
        ...
        <div className="group-hover:flex items-center gap-2 hidden mt-1">
          ...
          <TriggerChatbotTypeSheet sheetData={data} id={id}>
            <EditIcon className="w-3 h-3 cursor-pointer" />
          </TriggerChatbotTypeSheet>
          <DeleteIcon
...
export default TriggerChatbotType;
