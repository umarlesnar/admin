...
const SendOrderStatusSheet = ({ children, sheetData, id }: Props) => {
  ...
  return (
    <Formik
      ...
      enableReinitialize
    >
      {({ values, errors, handleSubmit, handleChange, resetForm, setFieldValue }: any) => {
        return (
          <Sheet
            open={open}
            onOpenChange={(value) => {
...
export default SendOrderStatusSheet;
