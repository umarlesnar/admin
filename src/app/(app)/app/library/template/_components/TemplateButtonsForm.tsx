...
import TemplateButtonPopover from "./TemplateButtonPopover";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { TemplateActionButtonDropdoown } from "./TemplateActionButtonDropdoown";
import TemplateButtonSampleContent from "./TemplateButtonSampleContent";
...
const TemplateButtonsForm = ({ button, index }: Props) => {
  ...
  return (
    <div className="w-full space-y-2 px-4 pt-2 pb-4">
                    ...
                    return (
                      <div className="w-full" key={`${index}_${idx}`}>
                        {button.type == "QUICK_REPLY" && (
                          <Card>
                            <div className="bg-neutral-20 py-2 px-4">
                              <Text weight="semibold">Quick Reply</Text>
                            </div>
                        ...
                        {button.type == "OTP" &&
                          button?.otp_type == "copy_code" && (
                            <div className="w-full flex items-end gap-4  p-3">
                              <Input
                                label={"Button text"}
                                name={`components.${index}.buttons.${idx}.text`}
                                onChange={handleChange}
