...
import { useNotificationQuery } from "@/framework/workspace/notification/get-notification";
...
export const NotificationList = (props: Props) => {
  ...
  const { data, isLoading, refetch } = useNotificationQuery(workspaceId);
  // const { mutateAsync } = useAlertMessageMutation();
