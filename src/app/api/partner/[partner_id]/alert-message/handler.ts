...
router
  ...
  .get(async (req: AppNextApiRequest, { params }: any) => {
    ...
    const totalCount = await alertMessageSchema.countDocuments(finalFilterQuery);
    ...
    let skip: any =
      AlertMessageQueryValidation.page > 0
        ? (AlertMessageQueryValidation.page - 1) * AlertMessageQueryValidation.per_page
        : 0;
