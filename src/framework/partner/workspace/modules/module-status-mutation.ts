...
export function WorkspaceModuleMutationApi(input: IWorkspaceModuleMutation) {
  const finalUrl = `${API_ENDPOINTS.PARTNER}/${input.partner_id}/${API_ENDPOINTS.WORKSPACE}/${input.workspace_id}/${API_ENDPOINTS.MODULES}/${input.modules_id}`;
...
//custom hook
export const useWorkspaceModuleMutation = () => {
