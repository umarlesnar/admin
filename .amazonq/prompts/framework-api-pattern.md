...
## Overview
This project uses a domain-driven structure for REST API interactions with React Query and Axios. The framework directory is organized by business domains, with each domain containing its own query and mutation logic.
...
## Domain-Specific API Logic Pattern
